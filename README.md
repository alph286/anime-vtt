...
profilo, non solo il flag da riga di comando), e il cursore del mouse è
sempre nascosto su `/display` via CSS (`cursor: none` sulla pagina stessa
-- funziona identico sotto X11 o Wayland, senza pacchetti aggiuntivi).
